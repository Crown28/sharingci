...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  Widget build(BuildContext context) {
    Duration diff1 =
        DateTime.parse(widget.order.endDate).difference(DateTime.now());
    ...
    Duration diff2 =
        DateTime.parse(widget.order.startDate).difference(DateTime.now());
